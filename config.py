...
default_terms_csv = "bild4_week4_running.csv"
...
app_author = "courtesy of Keefe Reuther, Assistant Teaching Professor in the UC San Diego School of Biological Sciences"
